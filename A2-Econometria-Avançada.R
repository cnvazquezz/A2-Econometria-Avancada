...
y <- rep(3,10) # utilizado para criar objeto y com 10 repetiÃ§Ãµes do nÃºmero 3
...
data("pwt8.0") #carrega os dados pwt8.0 disponÃ­veis no pacote
...
plot(dados, col="blue", main="Dados Brasileiros", xlab="Ano") #muda o tÃ­tulo e a cor das linhas do grÃ¡fico para azul
